...
export const getAll: RequestHandler = async (req, res) => { // Função para listar todos os grupos do evento X
...
export const getGroup: RequestHandler = async (req, res) => { // Função para listar apenas um grupo do evento X
...
export const addGroup: RequestHandler = async (req, res) => { // Função para adicionar um novo grupo do evento X
    const { id_event } = req.params;
...
export const updateGroup: RequestHandler = async (req, res) => { // Função para atualizar um grupo do evento X
    const {id, id_event } = req.params;
...
export const deleteGroup: RequestHandler = async (req, res) => { // Função para excluir um grupo do evento X
    const { id, id_event } = req.params;
