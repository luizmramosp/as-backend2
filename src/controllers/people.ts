...
export const getAll: RequestHandler = async(req, res) => { // Função para listar todas as pessoas de um evento X e de um grupo X
...
export const getPerson: RequestHandler = async (req, res) => { // Função para listar apenas uma pessoa de um evento X e de um grupo X
...
export const addPerson: RequestHandler = async (req, res) => { // Função para adicionar pessoas em um evento X e em um grupo X
    const { id_event, id_group } = req.params;
...
export const updatePerson: RequestHandler = async (req, res) => { // Função para atualzar uma pessoa de um evento X e de um grupo X
    const { id, id_event, id_group } = req.params;
...
export const deletePerson: RequestHandler = async (req, res) => { // Função para excluir uma pessoa de um evento X e de um grupo X
    const { id, id_event, id_group } = req.params;
